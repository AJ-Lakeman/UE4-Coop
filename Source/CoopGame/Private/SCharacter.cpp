...
void ASCharacter::EquipWeapon(TSubclassOf<class ASWeapon> WeaponToEquip)
{
...
void ASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ToggleCrouch", IE_Pressed, this, &ASCharacter::ToggleCrouch);
...
void ASCharacter::ApplyRecoil(float RecoilToApply)
{
	Recoil -= RecoilToApply;
}
